  ...
  $('.office-space__gallery').slick(
    {
      ...
      slidesToShow: 1,
      slidesToScroll: 1,
      nextArrow: '<span class="my-arrow my-arrow__next"><img src="image/arrows/arrow-right.png"></span>',
      prevArrow: '<span class="my-arrow my-arrow__prev"><img src="image/arrows/arrow-left.png"></span>',
      infinite: false
    }
  )
  });
